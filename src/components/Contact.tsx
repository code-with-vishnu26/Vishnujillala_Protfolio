        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4">
              <motion.div
                whileHover={{ x: 10 }}
                className="flex items-center space-x-3 sm:space-x-4 text-gray-300 hover:text-white transition-colors duration-200"
              >
              ...
              <motion.div
                ...
                className="flex items-center space-x-3 sm:space-x-4 text-gray-300 hover:text-white transition-colors duration-200"
              >
                <Phone size={18} className="text-green-400 sm:w-5 sm:h-5" />
              ...
              <motion.div
                ...
                className="flex items-center space-x-3 sm:space-x-4 text-gray-300 hover:text-white transition-colors duration-200"
              >
                <MapPin size={18} className="text-red-400 sm:w-5 sm:h-5" />
                ...
                {socialLinks.map((link) => {
                  ...
                  return (
                    <motion.a
                      ...
                      className={`p-2.5 sm:p-3 bg-white/5 rounded-full border border-white/10 text-gray-400 ${link.color} transition-all duration-300`}
                    >
          ...
          >
            <form
              ...
              className="bg-white/5 backdrop-blur-sm rounded-2xl p-5 sm:p-6 md:p-8 border border-white/10 space-y-4 sm:space-y-6"
            >
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors duration-200 text-sm sm:text-base"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors duration-200 resize-none text-sm sm:text-base"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center space-x-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 text-sm sm:text-base"
              >
